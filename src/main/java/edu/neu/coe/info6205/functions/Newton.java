...
public class Newton {
    ...
    public static void main(String[] args) {
        ...
        //My Test
        //Shuyan Wang (NUID: 001053908)
        Newton myNewton = new Newton("4 * x * x * x + x + 0.7", (double x) -> 4*x*x*x + x + 0.7, (double x) -> 12*x*x + 1 );
        Either<String, Double> myResult = myNewton.solve(0, 300, 1E-7);
        myResult.apply(
                System.err::println,
                aDouble -> {
                    System.out.println("-------------------Test by Shuyan Wang------------------");
                    System.out.println(myNewton.equation+" was solved: "+aDouble);
                }
        );
