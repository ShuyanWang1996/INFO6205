...
public class ShellSortTest {
    ...
    public void hSort1() {
        ...
        //original code: t.invokePrivateExplicit("hSort", classes, 4, xs, 0, xs.length);
        t.invokePrivateExplicit("hSort", classes, 4, xs, 0, xs.length-1);
    ...
    public void sort2() throws Exception {
        ...
        //original code: ss.sort(xs, 0, xs.length);
        ss.sort(xs, 0, xs.length-1);
        assertArrayEquals(zs, xs);
    }
    ...
    public void sort4() throws Exception {
        ...
        Sort ss = new ShellSort<Integer>(3);
        //original code: ss.sort(xs, 11, xs.length-1);
        ss.sort(xs, 11, xs.length-1);
        assertArrayEquals(zs, xs);
    }
